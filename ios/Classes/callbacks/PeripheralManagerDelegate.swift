...
//            }
    ...
    func peripheralManagerDidStartAdvertising(_ peripheral: CBPeripheralManager, error: Error?) {
        ...
        if (error != nil) {
            SwiftFlutterBlePeripheralPlugin.result!(FlutterError(code: "ios", message: error?.localizedDescription, details: error.self))
        } else {
            SwiftFlutterBlePeripheralPlugin.result!(nil)
        }
